...
export default function CartPage() {
  ...
  useEffect(() => {
    // Chỉ fetch cart khi đã load xong và user đã đăng nhập
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-600">{cart?.totalItems || 0} sản phẩm trong giỏ hàng</p>
          </div>
          <Link href="/shop">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg p-6 shadow-sm sticky top-4 border">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-2xl font-bold text-orange-600">{formatCurrency(cart.totalPrice)}</span>
                </div>
